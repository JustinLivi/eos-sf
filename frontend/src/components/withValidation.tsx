...
export interface InputValidationProps<FormFields, InnerInputProps> extends FormProps<FormFields> {
...
export function withValidation<InnerInputProps>(Input: React.ComponentClass<InputProps & InnerInputProps> | React.SFC<InputProps & InnerInputProps>) {
    return class InputWithValidation<FormFields> extends React.Component<InputValidationProps<FormFields, InnerInputProps>> {
        render() {
            const {
                fieldLabel,
                fieldId,
